                ...
                <div class="d-inline-block align-items-center">
                    <nav>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Floor List</li>
                        </ol>
                    </nav>
                </div>
            </div>
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    @foreach ($list as $row)
                                        <tr>
                                            <td>{{ $row->id }}</td>
                                            <td>{!! DNS2D::getBarCodeSVG($row->location_codes, 'QRCODE') !!}</td>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Products for Floor {{ $row->location_codes }}</h5>
                    ...
                    <div class="modal-body">
                        <table id="statusTable{{ $row->id }}" class="table table-bordered">
                            ...
                            <tbody>
                                @php
                                    $productsForFloor = \App\Models\Product::where('floor_id', $row->id)->get();
                                @endphp

                                @foreach ($productsForFloor as $product)
                                    <tr>
